...
from navigation import render_page_with_router

# Route to the selected page using the navigation system
if page in ["📊 Stock Analysis", "🤖 AI Deep Analysis"]:
    # These pages need date parameters
    render_page_with_router(page, start_date, end_date)
elif page:  # All other pages
    render_page_with_router(page)

# Legacy page routing - kept for backward compatibility but should be removed
# TODO: Remove all the elif statements below after confirming navigation system works
    create_section_header(
